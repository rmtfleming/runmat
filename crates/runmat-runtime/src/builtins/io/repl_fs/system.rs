...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::io::repl_fs::system")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::io::repl_fs::system")]
...
#[runtime_builtin(
    name = "system",
    category = "io/repl_fs",
    summary = "Run an operating-system command and return its exit status and captured output.",
    keywords = "system,command,shell,process,exit status,cmdout",
    descriptor(crate::builtins::io::repl_fs::system::SYSTEM_DESCRIPTOR),
    builtin_path = "crate::builtins::io::repl_fs::system"
)]
