...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::logical::tests::iscellstr")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::logical::tests::iscellstr")]
...
#[runtime_builtin(
    ...
    summary = "Return true when a value is a cell array of character vectors.",
    keywords = "iscellstr,cellstr,cell,char,type,predicate",
    accel = "metadata",
    type_resolver(bool_scalar_type),
    descriptor(crate::builtins::logical::tests::iscellstr::ISCELLSTR_DESCRIPTOR),
