...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::logical::tests::isrow")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::logical::tests::isrow")]
...
#[runtime_builtin(
    ...
    summary = "Return true when a value is a row vector (1-by-N).",
    keywords = "isrow,row,vector,shape,predicate",
    accel = "metadata",
    type_resolver(bool_scalar_type),
    descriptor(crate::builtins::logical::tests::isrow::ISROW_DESCRIPTOR),
    builtin_path = "crate::builtins::logical::tests::isrow"
)]
