...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::logical::tests::istable")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::logical::tests::istable")]
...
#[runtime_builtin(
    ...
    summary = "Return true when a value is a table.",
    keywords = "istable,table,type,predicate",
    accel = "metadata",
    type_resolver(bool_scalar_type),
    descriptor(crate::builtins::logical::tests::istable::ISTABLE_DESCRIPTOR),
    builtin_path = "crate::builtins::logical::tests::istable"
)]
