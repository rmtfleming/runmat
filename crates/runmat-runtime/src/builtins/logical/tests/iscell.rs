...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::logical::tests::iscell")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::logical::tests::iscell")]
...
#[runtime_builtin(
    ...
    descriptor(crate::builtins::logical::tests::iscell::ISCELL_DESCRIPTOR),
