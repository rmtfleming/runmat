...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::logical::tests::iscolumn")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::logical::tests::iscolumn")]
...
#[runtime_builtin(
    ...
    summary = "Return true when a value is a column vector (N-by-1).",
    keywords = "iscolumn,column,vector,shape,predicate",
    accel = "metadata",
    type_resolver(bool_scalar_type),
    descriptor(crate::builtins::logical::tests::iscolumn::ISCOLUMN_DESCRIPTOR),
    builtin_path = "crate::builtins::logical::tests::iscolumn"
)]
