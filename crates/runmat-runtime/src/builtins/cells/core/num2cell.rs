...
use crate::builtins::cells::type_resolvers::num2cell_type;
...
#[runtime_builtin(
    name = "num2cell",
    category = "cells/core",
    summary = "Convert an array to a cell array of its elements, optionally grouped along dimensions.",
    keywords = "num2cell,cell array,convert,group,dimension",
    type_resolver(num2cell_type),
