...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::strings::core::strncmpi")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::strings::core::strncmpi")]
...
#[runtime_builtin(
    ...
    keywords = "strncmpi,string compare,prefix,ignore case,text equality",
    accel = "sink",
    type_resolver(logical_text_match_type),
    descriptor(crate::builtins::strings::core::strncmpi::STRNCMPI_DESCRIPTOR),
    builtin_path = "crate::builtins::strings::core::strncmpi"
)]
