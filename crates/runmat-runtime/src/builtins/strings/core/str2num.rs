...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::strings::core::str2num")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::strings::core::str2num")]
...
#[runtime_builtin(
    ...
    summary = "Convert character text to numeric values by evaluating it; returns empty when evaluation fails.",
    keywords = "str2num,string to number,text conversion,eval",
    examples = "X = str2num('[1 2; 3 4]');",
    accel = "sink",
    type_resolver(unknown_type),
    descriptor(crate::builtins::strings::core::str2num::STR2NUM_DESCRIPTOR),
    builtin_path = "crate::builtins::strings::core::str2num"
)]
