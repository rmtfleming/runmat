...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::strings::core::dec2bin")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::strings::core::dec2bin")]
...
#[runtime_builtin(
    ...
    summary = "Convert nonnegative integers to a character array of binary digits.",
    keywords = "dec2bin,binary,base conversion,decimal to binary",
    examples = "txt = dec2bin(5, 8);",
    type_resolver(string_scalar_type),
    descriptor(crate::builtins::strings::core::dec2bin::DEC2BIN_DESCRIPTOR),
    builtin_path = "crate::builtins::strings::core::dec2bin"
)]
