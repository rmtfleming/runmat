...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::strings::search::strtok")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::strings::search::strtok")]
...
#[runtime_builtin(
    ...
    summary = "Return the first delimited token of a text input and the remainder.",
    keywords = "strtok,token,delimiter,split,whitespace",
    descriptor(crate::builtins::strings::search::strtok::STRTOK_DESCRIPTOR),
    builtin_path = "crate::builtins::strings::search::strtok"
)]
