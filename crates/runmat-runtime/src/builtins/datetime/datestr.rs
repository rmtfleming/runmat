...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::datetime::datestr")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::datetime::datestr")]
...
#[runtime_builtin(
    name = "datestr",
    category = "datetime",
    summary = "Convert a serial date number to character date text.",
    keywords = "datestr,date,serial date number,format,char",
    related = "datetime",
    examples = "s = datestr(738885);",
    descriptor(crate::builtins::datetime::datestr::DATESTR_DESCRIPTOR),
    builtin_path = "crate::builtins::datetime::datestr"
)]
