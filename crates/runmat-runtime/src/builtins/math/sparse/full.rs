...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::math::sparse::full")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::math::sparse::full")]
...
#[runtime_builtin(
    ...
    summary = "Convert sparse matrices to full (dense) storage; full inputs pass through.",
    keywords = "full,sparse,dense,storage,conversion",
    accel = "custom",
    type_resolver(full_type),
    descriptor(crate::builtins::math::sparse::full::FULL_DESCRIPTOR),
    builtin_path = "crate::builtins::math::sparse::full"
)]
