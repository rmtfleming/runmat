...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::math::sparse::spdiags")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::math::sparse::spdiags")]
...
#[runtime_builtin(
    ...
    summary = "Extract the nonzero diagonals of a matrix or build a sparse matrix from diagonals.",
    keywords = "spdiags,sparse,diagonal,banded,construct,extract",
    accel = "custom",
    type_resolver(spdiags_type),
    descriptor(crate::builtins::math::sparse::spdiags::SPDIAGS_DESCRIPTOR),
    builtin_path = "crate::builtins::math::sparse::spdiags"
)]
