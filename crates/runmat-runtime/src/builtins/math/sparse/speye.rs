...
#[runmat_macros::register_gpu_spec(builtin_path = "crate::builtins::math::sparse::speye")]
...
#[runmat_macros::register_fusion_spec(builtin_path = "crate::builtins::math::sparse::speye")]
...
#[runtime_builtin(
    ...
    summary = "Create a sparse matrix with ones on the main diagonal and zeros elsewhere.",
    keywords = "speye,sparse,identity,eye,diagonal",
    accel = "array_construct",
    type_resolver(speye_type),
    descriptor(crate::builtins::math::sparse::speye::SPEYE_DESCRIPTOR),
    builtin_path = "crate::builtins::math::sparse::speye"
)]
